...
<div class="container">
    ...
    <br/>
    <ol>
        <li><span>마이페이지 예약내역에서 진행 상태를 확인하세요</span><br/> <img src="/assets/checkReservation.png"></li>
        <br/>
        <li><span>호스트의 승인을 기다려주세요</span> <br/> <img class="advice" src="/assets/waiting.jpg"></li>
        <br/>
        <li><span>호스트의 승인이 완료되면 approved 상태가 됩니다. 이제 결제를 진행 주세요</span> <br/> <img class="advice"
                                                                                  src="/assets/approved.jpg"></li>
        <br/>
