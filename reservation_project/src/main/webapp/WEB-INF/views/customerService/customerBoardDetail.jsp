                    ...
                    <div class="reply_view">
                        ...
                        <div class=>
                            <div style="margin-top: 10px;">
                                ...
                                <button style="margin-top: 10px;" id="rep_bt" class="btn btn-dark float-right"
                                        onclick="writeReply(${board.id})">댓글
                                </button>
                            </div>
                        </div>
                        ...
                        <c:forEach var="reply" items="${board.replys}">
                            <li class="reply-list-${reply.id }">
                                ...
                                <div class="name time" style="font-size: 20px; color: black;">
                                    <strong>운영자</strong><a style="margin-left: 10px; color: grey;"><fmt:formatDate
                                        pattern="yyyy-MM-dd hh:mm" value="${reply.createTime}"/></a>
                                </div>
                                <div class="comment_content"
                                     style="font-family: sans-serif; color:black;">${reply.content }</div>
                                <sec:authorize access="hasRole('ROLE_ADMIN')">
