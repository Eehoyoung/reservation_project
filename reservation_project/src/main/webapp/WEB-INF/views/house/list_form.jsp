    ...
    <div class="container d-flex justify-content-end" style="width: 1050px;">
        <form class="form-inline" action="/user/house-list" method="get">
            ...
            <div class="form-group col-sm-6">
                ...
                <select class="form-control custom-selector" name="address" onchange="this.form.submit()"
                        style="width: 130px;">
            ...
            <div class="form-group col-sm-6">
                ...
                <select class="form-control custom-selector" name="type" onchange="this.form.submit()"
                        style="width: 130px;">
                    <option value="">전체</option>
                    <option ${selectedType eq '계곡 팬션' ? selected : notSelected}>계곡 팬션</option>
                    <option ${selectedType eq '바다 팬션' ? selected : notSelected}>바다 팬션</option>
                    <option ${selectedType eq '바다 호텔' ? selected : notSelected}>바다 호텔</option>
                    <option ${selectedType eq '도심 호텔' ? selected : notSelected}>도심 호텔</option>
    ...
    <div class="container">
        ...
        <div class="row">
            <c:forEach var="house" items="${houseList}">
                ...
                <div class="col-sm-4">
                    <div>
                        <a href="/user/house-detail/${house.id}"><img class="custom-img list-img"
