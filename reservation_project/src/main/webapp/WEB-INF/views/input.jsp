                    ...
                    <div class="card card-shadow col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2 reveal">
                                ...
                                <div class="col-md-7">
                                    <ul class="list-group">
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <p id="booker" class="align-items-center"
                                               style="transform: translate(0%,30%);">예약자
                                                : ${principal.user.username}</p>

                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <p id="count" class="align-items-center"
                                               style="transform: translate(0%,30%);">인원 수 : 1</p>
                                            <div style="transform: translate(0%,10%);">
                                                <a id="count-minus" type="button" class="m-1"><span
                                                        class="icon-minus-circle"></span></a>
                                                <a id="count-plus" type="button" class="m-1"><span
                                                        class="icon-plus-circle"></span></a>
                                            </div>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <p class="align-items-center" style="transform: translate(0%,30%);">예약일:
                                                <span id="bookingDate" style="font-size: 15px"> </span></p>
                                            <div>
                                                <a id="calender-btn" type="button" onclick="startModal()"
                                                   class="m-1"><span class="icon-calendar-o"></span></a>

                                            </div>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <input type="hidden" id="price"/>
                                            <p id="showPrice" class="align-items-center"
                                               style="transform: translate(0%,30%);">가격: 0￦</p>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            요청사항
                                            <div class="form-group">
                                                <textarea id="request" style="margin-top: 10px" class="form-control"
                        ...
                        <span class="fa-icon">
                          <i class="fa fa fa-map-o" aria-hidden="true"></i>
                                    ...
                                    <button onclick="reserveHouse(${principal.user.id},${house.hostId.id},${house.id})"
                                            class="custom-sm-btn">예약하기
                                    </button>
                                </div>
                            </div>
                        </form>
...
<div class="detail">
    <div id="check-table">
        ...
        <ul id="check-table-ul" class="list-group">
            <li class="list-group-item list-group-item-action">Checkin: <input type="date" id="checkIn-Date"
                                                                               style="width: 120px"/></li>
            <li class="list-group-item list-group-item-action">CheckOut: <input type="date" id="checkOut-Date"
                                                                                style="width: 120px"/></li>
        </ul>
