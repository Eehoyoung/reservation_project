                ...
                <div id="page-container">
                    ...
                    <div class="btn-box">
                        ...
                        <c:forEach var="house" items="${houses}">
                            <a type="button" class="btn " id="${house.name}"
                               onclick="checkHouseReservation(${house.hostId.id},${house.id})" style=""><span
                                    class="multiLine">${house.name}</span>
...
<script type="text/javascript" src="/js/reservation/hostReserveTable.js"></script>
</body>
