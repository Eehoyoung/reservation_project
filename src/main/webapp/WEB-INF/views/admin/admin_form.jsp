            ...
            <div class="col-xs-12 col-md-12">
                <div id="page-container">
                    <div class="jumbotron jumbotron-fluid"
                         style="margin: 10px; background-color: rgba(255, 149, 149, 0.05);">
                        <div class="container">
                            <h2>회원 관리</h2>
                    ...
                    <div class="d-flex flex-row-reverse">
                        <form class="form-inline" action="/admin/user-management" method="get">
                            <input type="text" class="form-control" style="margin: 10px; height: 40px;" name="q"
                                   value="${searchUser}" placeholder="회원 검색">
                            <button type="submit" class="custom-sm-btn" id="btn-search"
                                    style="font-size: 17px; width: 80px; margin-right: 10px;">검색
                            </button>
                        </form>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <c:choose>
                                            <c:when test="${user.reportCount > 4}">
                                                <td onclick="index.deleteById(${user.id})"
                                                    style="font-size: 16px; color: red; cursor: pointer;">삭제
                                                </td>
                                            </c:when>
                                            <c:otherwise>
                                                <td></td>
