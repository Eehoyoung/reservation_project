    ...
    <div id="yourName">
        <table class="inputTable">
            <tr>
                ...
                <th>
                    <button onclick="chatName()" id="startBtn " style="margin-left:50px; width: 80px;">등록</button>
                </th>
            </tr>
        </table>
    </div>
    <div id="yourMsg">
        <table class="inputTable">
            <tr>
                ...
                <th>
                    <button onclick="send()" id="sendBtn" style="margin-left:30px; width: 80px;">보내기</button>
                </th>
            </tr>
        </table>
    </div>
