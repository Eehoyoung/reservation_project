...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9b9362b07f826b6a20e5da1cc7eb0446"></script>
<script type="text/javascript"
        src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9b9362b07f826b6a20e5da1cc7eb0446&libraries=LIBRARY"></script>
<script type="text/javascript"
        src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9b9362b07f826b6a20e5da1cc7eb0446&libraries=services"></script>
<script type="text/javascript"
        src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9b9362b07f826b6a20e5da1cc7eb0446&libraries=services,clusterer,drawing"></script>
...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="container">
                <div class="col-md-6">
                    <img class="card-img-top mb-5 mb-md-0" src="http://localhost:9090/upload/${house.image.imageUrl}"
                ...
                <div class="col-md-6">
                    ...
                    <div class="fs-5 mb-5 d-flex">
                        <span class="text-decoration-line-through flex-shrink-0"
                              style="margin-top: 5px;">#${house.address}&nbsp;#${house.type}</span>
                    </div>
                    <a style="cursor: pointer;" onclick="requestXYData(${house.id})"> 지도보기 &nbsp;<i
                    ...
                    <div class="d-flex" style="position: absolute; bottom: -17%;">
                        <button class="custom-btn flex-shrink-0" onclick="location.href='/guest/bookForm/${house.id}'"
                                type="button">예약하기
                        </button>
                        <c:if test="${principal ne null}">
                            <div class="d-flex" style="margin-top: 5px;">
                                <i class="bi ${not empty likeHouse.house ? exist : notExist}"
                                   style="margin-left: 30px; cursor: pointer;" id="like" onclick="clickHeart()"></i>&nbsp;&nbsp;
                    ...
                    <c:choose>
                        <c:when test="${reviews.first}">
                            <li class="page-item disabled"><a class="page-link"
                                                              href="/user/house-detail/${house.id}?page=${reviews.pageable.pageNumber - 1}"><b>&lt;</b></a>
                            </li>
                        </c:when>
                        <c:otherwise>
                ...
                <c:forEach var="house" items="${houseList}">
                    ...
                    <div class="col mb-5">
                        <div class="custom-card h-100">
                            <a href="/user/house-detail/${house.id}"> <img class="custom-card-img"
