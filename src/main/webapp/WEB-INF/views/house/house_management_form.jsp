...
<div class="container">
    ...
    <div class="container">
        <c:forEach var="house" items="${houseList}">
            <div class="col-xl">
                <div class="row">
                    <a data-toggle="modal" data-target="#info-modal-${house.id}" style="cursor: pointer;"> <img
                            class="custom-img" src="http://localhost:9090/upload/${house.image.imageUrl}"
                    ...
                    <div class="col" style="position: absolute; bottom: 5%; left: 18%">
                        <a href="/host/update_form/${house.id}" style="margin-right: 5px; color: rgb(67, 0, 232)">수정</a>
                        <a onclick="index.deleteHouse('${house.id}')"
                           style="color: red; margin-right: 5px; color: rgb(203, 0, 0); cursor: pointer;">삭제</a> <a
                            href="/host/review-management/${house.id}" style="color: black">리뷰 관리</a>
                    </div>
                </div>
