...
<nav class="navbar navbar-expand-lg">
    <div id="naviBar" class="navbar-expand-lg ">
        <a id="header-text" class="navbar-brand" href="/">BANG</a>
    ...
    <div id="user-box-header">
        ...
        <c:choose>
            <c:when test="${empty principal}">
                ...
                <a href="/auth/join_form" class="list-group-item list-group-item-action"> <span
                        class="icon-user-plus"></span>&nbsp;&nbsp;회원가입
                </a>

            </c:when>
            <c:otherwise>
                <a class="list-group-item list-group-item-action" href="/logout"> <span
                        class="icon-drivers-license-o"></span>&nbsp;&nbsp;로그아웃
                </a>
                <a href="/user/my-page" class="list-group-item list-group-item-action"> <span class="icon-user"></span>&nbsp;&nbsp;${principal.user.role eq 'ADMIN' ? '관리자 페이지' : '마이페이지' }
                </a>
        ...
        <sec:authorize access="hasRole('ROLE_GUEST')">
            <a type="button" class="list-group-item list-group-item-action" href="/guest/be-host"> <span
                    class="icon-black-tie"></span>&nbsp;&nbsp;호스트 되기
            </a>

        </sec:authorize>
        <sec:authorize access="hasRole('ROLE_HOST')">
            <a type="button" class="list-group-item list-group-item-action" href="/host/be-guest"> <span
                    class="icon-black-tie"></span>&nbsp;&nbsp;게스트 되기
            </a>
        </sec:authorize>
