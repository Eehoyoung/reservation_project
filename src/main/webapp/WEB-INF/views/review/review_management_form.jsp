...
<div class="py-5" id="features">
    ...
    <div class="container">
        ...
        <c:forEach var="review" items="${reviews.content}">
            ...
            <div class="col-xl">
                <div class="row">
                    ...
                    <div class="float-right">
                        <a data-toggle="modal" data-target="#report-modal-${review.id}"
                           style="color: red; margin-left: 700px; cursor: pointer;">신고</a>
                    </div>
                </div>
                <hr>
                <div class="row">
            ...
            <!-- 신고 모달 -->
            <div class="modal" id="report-modal-${review.id}" tabindex="-1" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="close" id="close-${review.id}" data-dismiss="modal"
                                    aria-label="Close">
                            ...
                            <div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <h4>상세 사유 및 설명</h4>
                                        <textarea id="detail-text-${review.id}"
                                                  placeholder="부적절한 신고 및 허위 신고의 경우 운영원칙에 따라 제재를 받을 수 있습니다."
                                                  style="height: 250px;" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer">
                            <button id="btn-report-review" class="custom-report-btn"
                                    onclick="index.reportReview(${review.id})">신고하기
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div id="title" class="container">
                ...
                <br>
                <form class="mb-5">
                    <textarea class="form-control" rows="3" id="reply-content-${review.id}"
                              placeholder="게스트의 리뷰에 대한 답글을 남겨주세요!"></textarea>
                </form>
                <div>
                    <button type="button" id="btn-save-reply" class="custom-sm-btn float-right"
                            onclick="index.addReply(${review.id})">등록
                    </button>
                </div>
                <br> <br>
                <!-- 댓글 목록 -->
                        ...
                        <li class="list-group-item d-flex justify-content-between" id="reply--${reply.id}">
                            ...
                            <div class="d-flex">
                                <a class="host-review-update"
                                   onclick="index.editText('${reply.id}', '${reply.content}', '${review.id}');"
                                   style="cursor: pointer; color: rgb(17, 56, 147)">수정</a> &nbsp;&nbsp; <a
                                    class="host-review-delete"
                                    style="color: red" onclick="index.deleteReply(${reply.id});"
                                    style="cursor: pointer; color: rgb(203, 0, 0);">삭제</a>
                            </div>
                        </li>
                    </c:forEach>
                </ul>
...
<div class="container justify-content-center" style="margin-left: 45%">
    <c:if test="${reviewCount ne 0}">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item ${reviews.first ? isDisabled : isAbled}"><a class="page-link"
                                                                             href="/host/review-management/${houseId}?page=${reviews.number - 1}">Prev</a>
            </li>
                ...
                <c:choose>
                    <c:when test="${reviews.number + 1 eq num}">
                        <li class="page-item active"><a class="page-link"
                                                        href="/host/review-management/${houseId}?page=${num - 1}">${num}</a>
                        </li>
                    </c:when>
                    <c:otherwise>
            ...
            <li class="page-item ${reviews.last ? isDisabled : isAbled}"><a class="page-link"
                                                                            href="/host/review-management/${houseId}?page=${reviews.number + 1}">Next</a>
            </li>
