        ...
        <div class="container-signup">
            <div class="signup-content">
                <div class="signup-form needs-validation">
                    ...
                    <form action="/auth/joinProc" method="post" onsubmit="return joinCheck()" class="register-form"
                          id="register-form">
                        ...
                        <div class="form-group" data-validate="Password is required">
                            <label for="password"><i class="zmdi zmdi-lock-outline"></i></label> <input type="password"
                                                                                                        name="password"
                                                                                                        id="password"
                        ...
                        <div class="form-group">
                            <label for="re-password"><i class="zmdi zmdi-lock-outline"></i></label> <input
                                type="password" name="re-password" id="re-password" placeholder="Repeat your password"
                                required/>
                        </div>

                        <div class="form-group">
                            <label for="email"><i class="zmdi zmdi-email"></i></label> <input type="email" name="email"
                                                                                              id="email"
                        ...
                        <div class="form-group">
                            <label for="email"><i class="zmdi zmdi-phone"></i></label> <input type="text"
                                                                                              name="phoneNumber"
                                                                                              id="phoneNumber"
