...
<div class="container">
    ...
    <div class="row gx-4 gx-lg-5">
        ...
        <sec:authorize access="hasRole('ROLE_GUEST')">
            ...
            <div class="col-sm-4 mb-5" onclick="location.href='/guest/wish-list/${principal.user.id}'"
            ...
            <div class="col-sm-4 mb-5" onclick="location.href='/guest/my-review-list/${principal.user.id}'"
                 style="cursor: pointer;">
                <div class="card h-100 my-card">
                    <div class="card-body">
            ...
            <div class="col-sm-4 mb-5" onclick="location.href='/admin/user-management'" style="cursor: pointer;">
                <div class="card h-100 my-card">
                    <div class="card-body">
                        ...
                        <p class="card-text">BANG 회원의 가입 현황을 확인하세요.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 mb-5" onclick="location.href='/admin/show-statistics'" style="cursor: pointer;">
                <div class="card h-100 my-card">
                    <div class="card-body">
                        ...
                        <p class="card-text">BANG 회원과 숙소의 데이터 현황을 확인하세요.</p>
                    </div>
                </div>
            </div>
        </sec:authorize>
