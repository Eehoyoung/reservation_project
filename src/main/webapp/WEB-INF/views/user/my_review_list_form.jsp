        ...
        <div class="col-xl">
            <div class="row">
                ...
                <div class="col" style="position: absolute; left: 90%;">
                    <a href="/guest/review/update_form/${review.id}" style="margin-right: 10px;">수정</a> <a
                        onclick="index.deleteReview(${review.id})"
                        style="color: red; margin-right: 10px; cursor: pointer;">삭제</a>
                </div>
                ...
                <c:forEach var="reply" items="${review.replies}">
                    <li class="list-group-item d-flex justify-content-between" id="reply--${reply.id}">
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                <a data-toggle="modal" data-target="#report-modal-${reply.id}"
                                   style="color: red; cursor: pointer;">신고</a>
                            </div>
                        </div>
                    </li>

                    <!-- 신고 모달 -->
                    <div class="modal" id="report-modal-${reply.id}" tabindex="-1" aria-labelledby="exampleModalLabel"
                         aria-hidden="true">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <button type="button" id="close-${reply.id}" class="close" data-dismiss="modal"
                                            aria-label="Close">
                                    ...
                                    <div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <h4>상세 사유 및 설명</h4>
                                                <textarea id="detail-text-${reply.id}"
                                ...
                                <div class="modal-footer">
                                    <button type="button" onclick="index.reportReply(${reply.id})"
                                            class="custom-sm-btn">신고하기
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <c:if test="${reviewCount ne 0}">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item ${reviews.first ? isDisabled : isAbled}"><a class="page-link"
                                                                             href="/guest/my-review-list/${principal.user.id}?page=${reviews.number - 1}">Prev</a>
            </li>
                ...
                <c:choose>
                    <c:when test="${reviews.number + 1 eq num}">
                        <li class="page-item active"><a class="page-link"
                                                        href="/guest/my-review-list/${principal.user.id}?page=${num - 1}">${num}</a>
                        </li>
                    </c:when>
                    <c:otherwise>
            ...
            <li class="page-item ${reviews.last ? isDisabled : isAbled}"><a class="page-link"
                                                                            href="/guest/my-review-list/${principal.user.id}?page=${reviews.number + 1}">Next</a>
            </li>
