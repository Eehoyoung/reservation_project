            ...
            <div class="signup-content">
                <div class="signup-form">
                    ...
                    <div class="form-group">
                        <input value="${principal.user.id}" id="user-id" type="hidden"> <label for="name"><i
                    ...
                    <div class="form-group">
                        <label for="password"><i class="zmdi zmdi-lock-outline"></i></label> <input type="password"
                                                                                                    id="password"
                                                                                                    placeholder="Password" ${principal.user.loginType == 'KAKAO' ? isDisabled : isAbled} />
                    </div>
                    ...
                    <div class="form-group">
                        <label for="phoneNumber"><i class="zmdi zmdi-phone"></i></label> <input type="text"
