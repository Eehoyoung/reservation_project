...
function validCheckInOutDate() {
    let outDate = parseDateType(
        $("#checkOut-Date").val()
    );
    let inDate = parseDateType(
        $("#checkIn-Date").val()
    );
    for (
        let i = 0;
